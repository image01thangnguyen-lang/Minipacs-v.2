# Phase 4 PR6 — Layout Preferences, Responsive và UAT

Ngày lập: 2026-07-11  
Phase cha: [DOCTOR_WORKSPACE_PHASE4_SEVEN_REGION_RELATED_STUDIES_PLAN.md](./DOCTOR_WORKSPACE_PHASE4_SEVEN_REGION_RELATED_STUDIES_PLAN.md), sau [DOCTOR_WORKSPACE_PHASE4_PR5_RELATED_STUDIES_PANEL_PLAN.md](./DOCTOR_WORKSPACE_PHASE4_PR5_RELATED_STUDIES_PANEL_PLAN.md)  
Trạng thái: kế hoạch triển khai độc lập; inventory code thực tế là gate bắt buộc

## 1. Mục tiêu và kết quả

Lưu splitter/collapse theo user, clamp/version preference và nghiệm thu các breakpoint trước Phase 5.
...
Trọng tâm riêng: **Corrupt/old preference, multi-tab semantics, reset, 1024–2560, visual/a11y regression và rollback.**
...
Targeted matrix: Corrupt/old preference, multi-tab semantics, reset, 1024–2560, visual/a11y regression và rollback.
...
```text
Làm việc tại C:\Antigravity\Minipacs-v.2. Triển khai Phase 4 PR6 — Layout Preferences, Responsive và UAT.

Đọc master plan, docs/DOCTOR_WORKSPACE_PHASE4_SEVEN_REGION_RELATED_STUDIES_PLAN.md, docs/DOCTOR_WORKSPACE_PHASE4_PR6_LAYOUT_PREFERENCES_RESPONSIVE_UAT_PLAN.md và mọi PR tiền đề. Trước khi sửa, chạy git status/diff read-only; inventory callers/schema/authz scope/workflow/audit/tests/flags; bảo toàn worktree và ghi baseline kiểm chứng được.

Mục tiêu: Lưu splitter/collapse theo user, clamp/version preference và nghiệm thu các breakpoint trước Phase 5.
Trọng tâm: Corrupt/old preference, multi-tab semantics, reset, 1024–2560, visual/a11y regression và rollback.
