# Phase 6 PR8 — Cross-page Visual, Accessibility và Performance Regression

Ngày lập: 2026-07-11  
Phase cha: [DOCTOR_WORKSPACE_PHASE6_SHARED_LIST_UI_ADOPTION_PLAN.md](./DOCTOR_WORKSPACE_PHASE6_SHARED_LIST_UI_ADOPTION_PLAN.md), sau [DOCTOR_WORKSPACE_PHASE6_PR7_ADMIN_TABLE_ADOPTION_CLEANUP_PLAN.md](./DOCTOR_WORKSPACE_PHASE6_PR7_ADMIN_TABLE_ADOPTION_CLEANUP_PLAN.md)  
Trạng thái: kế hoạch triển khai độc lập; inventory code thực tế là gate bắt buộc

## 1. Mục tiêu và kết quả

Chạy gate toàn ứng dụng, đóng ngoại lệ và xác nhận hệ UI nhất quán trước release phase.
...
Trọng tâm riêng: **Route matrix, keyboard/screen reader, 1280–2560, bundle/render/query budgets và known exceptions.**
...
Targeted matrix: Route matrix, keyboard/screen reader, 1280–2560, bundle/render/query budgets và known exceptions.
...
```text
Làm việc tại C:\Antigravity\Minipacs-v.2. Triển khai Phase 6 PR8 — Cross-page Visual, Accessibility và Performance Regression.

Đọc master plan, docs/DOCTOR_WORKSPACE_PHASE6_SHARED_LIST_UI_ADOPTION_PLAN.md, docs/DOCTOR_WORKSPACE_PHASE6_PR8_CROSS_PAGE_REGRESSION_PLAN.md và mọi PR tiền đề. Trước khi sửa, chạy git status/diff read-only; inventory callers/schema/authz scope/workflow/audit/tests/flags; bảo toàn worktree và ghi baseline kiểm chứng được.

Mục tiêu: Chạy gate toàn ứng dụng, đóng ngoại lệ và xác nhận hệ UI nhất quán trước release phase.
Trọng tâm: Route matrix, keyboard/screen reader, 1280–2560, bundle/render/query budgets và known exceptions.
