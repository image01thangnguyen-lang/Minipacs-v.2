# Phase 3 PR7 — Worklist Feature Flag, UAT và Cutover

Ngày lập: 2026-07-11  
Phase cha: [DOCTOR_WORKSPACE_PHASE3_WORKLIST_QUERY_FILTER_GRID_PLAN.md](./DOCTOR_WORKSPACE_PHASE3_WORKLIST_QUERY_FILTER_GRID_PLAN.md), sau [DOCTOR_WORKSPACE_PHASE3_PR6_COLUMN_PREFERENCES_ALLOWED_ACTIONS_PLAN.md](./DOCTOR_WORKSPACE_PHASE3_PR6_COLUMN_PREFERENCES_ALLOWED_ACTIONS_PLAN.md)  
Trạng thái: kế hoạch triển khai độc lập; inventory code thực tế là gate bắt buộc

## 1. Mục tiêu và kết quả

Chạy song song worklist cũ/mới, đo parity/latency, pilot và gỡ đường Orthanc fan-out sau soak period.
...
Trọng tâm riêng: **Old/new parity, rollback flag, large dataset, Orthanc outage, telemetry scrub và release evidence.**
...
Targeted matrix: Old/new parity, rollback flag, large dataset, Orthanc outage, telemetry scrub và release evidence.
...
```text
Làm việc tại C:\Antigravity\Minipacs-v.2. Triển khai Phase 3 PR7 — Worklist Feature Flag, UAT và Cutover.

Đọc master plan, docs/DOCTOR_WORKSPACE_PHASE3_WORKLIST_QUERY_FILTER_GRID_PLAN.md, docs/DOCTOR_WORKSPACE_PHASE3_PR7_WORKLIST_CUTOVER_PLAN.md và mọi PR tiền đề. Trước khi sửa, chạy git status/diff read-only; inventory callers/schema/authz scope/workflow/audit/tests/flags; bảo toàn worktree và ghi baseline kiểm chứng được.

Mục tiêu: Chạy song song worklist cũ/mới, đo parity/latency, pilot và gỡ đường Orthanc fan-out sau soak period.
Trọng tâm: Old/new parity, rollback flag, large dataset, Orthanc outage, telemetry scrub và release evidence.
