    ...
    <section aria-label="Second Read" className="mt-4 border border-vin-border rounded-md bg-vin-shell/30">
      ...
      <div className="p-3 flex flex-col gap-2">
        {loading ? (
          ...
          <div className="text-[11px] text-vin-muted text-center py-2">Chưa có yêu cầu</div>
        ) : (
          secondReads.map(sr => (
            <div key={sr.id} className="text-[11px] bg-vin-panel border border-vin-border p-2 rounded">
