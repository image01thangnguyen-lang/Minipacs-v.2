...
import { ArchiveAntd } from "./ArchiveAntd";
...
export default async function ArchivePage() {
  ...
  if (user?.id) {
    try {
      ...
      const decision = await evaluateScopedCapability({ capability: "antd-archive", resourceId: (user as any).activeFacilityId || "global" }, deps);
