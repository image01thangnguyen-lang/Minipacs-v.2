...
export const minipacsToolRegistry: MiniPacsTool[] = [
  ...
  { id: 'Axial', label: 'Axial', type: 'action', status: 'deferred-advanced', deferredReason: 'Pending safe viewport orientation logic (Phase 4)', placement: ['left-panel'] },
  { id: 'Coronal', label: 'Coronal', type: 'action', status: 'deferred-advanced', deferredReason: 'Pending safe viewport orientation logic (Phase 4)', placement: ['left-panel'] },
  { id: 'Sagittal', label: 'Sagittal', type: 'action', status: 'deferred-advanced', deferredReason: 'Pending safe viewport orientation logic (Phase 4)', placement: ['left-panel'] },
